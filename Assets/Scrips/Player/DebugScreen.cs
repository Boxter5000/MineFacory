...
public class DebugScreen : MonoBehaviour
{
    ...
    void LateUpdate() {
        ...
        string debugText = "release version: 0.0.01";
        debugText += "\n";
        ...
        debugText += "\n";
        debugText += "Chunk: " + (world._playerChunkCoord.x - halfWorldSizeInChunks) + " / " + (world._playerChunkCoord.z - halfWorldSizeInChunks);
